...
export default function() {
  ...
  if (jQuery('.block-gallery').length > 0) {
    jQuery('.block-gallery').each(function() {
      const $galleryslide = $('#' + jQuery(this).attr('id') + ' .galley');
      $galleryslide.slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: false,
        ...
        adaptiveHeight: true,
        centerPadding: 0,
        asNavFor: '#' + jQuery(this).attr('id') + ' .pag-galley',
      });
      const $gallerypagslide = $('#' + jQuery(this).attr('id') + ' .pag-galley');
      $gallerypagslide.slick({
        ...
        adaptiveHeight: true,
        centerPadding: 0,
        asNavFor: '#' + jQuery(this).attr('id') + ' .galley',
      });
    });
  }
