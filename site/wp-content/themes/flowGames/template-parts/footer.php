					...
					<div class="social-media visible-phablets visible-phone">
						<ul>
							...
							foreach ($US_socialMedia_repeater_decoded as $repeater_item) {
								echo '<li><a target="_blank" href="' . $repeater_item->link . '"><img src="' . $repeater_item->image_url . '" width="21" height="21"></a></li>';
							}
							?>
						</ul>
					</div>
			...
			<div class="partners">
				...
				<div class="logos-partners">
					...
					foreach ($US_partners_repeater_decoded as $repeater_item) {
						echo '<a target="_blank" href="' . $repeater_item->link . '"><img src="' . $repeater_item->image_url . '"></a>';
					}
					?>
				</div>
			</div>
